//! Per-example integration test for `examples/04-traefik-authelia/` (T019).
...
#[test]
fn example_04_traefik_authelia_parses_and_plans() {
    let example_dir = Path::new(env!("CARGO_MANIFEST_DIR")).join("examples/04-traefik-authelia");
...

    {
        ...
        .expect("parser load succeeds for 04-traefik-authelia");
