//! Per-example integration test for `examples/03-immich/` (T018).
...
#[test]
fn example_03_immich_parses_and_plans() {
    let example_dir = Path::new(env!("CARGO_MANIFEST_DIR")).join("examples/03-immich");
...

    {
        ...
        .expect("parser load succeeds for 03-immich");
