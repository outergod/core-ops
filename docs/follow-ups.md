...
- Status: Resolved in 0.8.2 — see `specs/014-config-restart-fidelity/` and `changes/014-config-restart-fidelity.md`; E2E regression scenario validated on live host: `tests/fixtures/verification/scenarios/accepted-config-change-restart.yaml`
